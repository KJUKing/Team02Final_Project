...
public class AccountServiceImpl implements AccountService {
	...
	public AccountVO readAccountExist(AccountVO account) {
		AccountVO rowAccount = mapper.selectAccountExist(account);
	...
	@Override
	public ServiceResult modifyStatusAccount(String accountMail) {
		int rowcnt = mapper.updateStatusAccount(accountMail);
		if(rowcnt>0) return ServiceResult.OK;
		else return ServiceResult.FAIL;
	}
